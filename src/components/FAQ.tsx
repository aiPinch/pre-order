...
const faqs = [
	...
	},
	{
		...
		answer:
			'Некоторые изменения в самочувствии вы можете заметить уже через несколько дней регулярного выполнения задач. Более существенные изменения в показателях здоровья обычно видны через 4–8 недель.',
	},
	{
