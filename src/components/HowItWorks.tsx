...
const steps = [
  {
    ...
    description: "Подключите ваши смарт‑девайсы — вы увидите ваши потенциальные риски и выберете, на чём сосредоточиться.",
  },
  {
    number: "02",
    icon: ListChecks,
    title: "Получите персональный план",
    description: "Получаете простые, выполнимые шаги по питанию, добавкам и активности — то, что реально вписать в обычный день.",
  },
  {
    number: "03",
    icon: TrendingUp,
    title: "Видимый прогресс",
    description: "Простые графики и общий индекс показывают изменения — вы видите, что это работает, и тревога снижается.",
  },
];
            ...
            <ScrollReveal key={index} delay={index * 150}>
              <div className="relative flex gap-6 md:gap-10 pb-12 last:pb-0">
                ...
                <div className="flex-shrink-0 w-12 h-12 md:w-20 md:h-20 rounded-2xl bg-primary/10 border border-primary/30 flex items-center justify-center relative z-10">
                  <span className="text-primary font-bold text-lg md:text-2xl">{step.number}</span>
                </div>
