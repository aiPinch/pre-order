...
const steps = [
	{
		...
		description:
			'Подключите смарт‑девайсы — AI проанализирует и покажет, где вы уязвимы больше всего или расскажите о своих рисках сами.',
	},
	{
		number: '02',
		icon: ListChecks,
		...
		description:
			'Получаете простые, выполнимые шаги по питанию, добавкам и активности — то, что реально вписать в обычный день.',
	},
	{
		number: '03',
		icon: TrendingUp,
		...
		description:
			'Простые графики и общий индекс показывают изменения — вы видите, что это работает, и тревога снижается.',
	},
];
