...
const cards = [
	{
		...
		description:
			'Пробовали добавки, ходили в зал — но не понимаете, что помогает именно вам.',
	...
	},
	{
		...
		description:
			'Вы понимаете, что это важно, но не знаете, как вписать советы в свой день, когда и так не хватает сил и времени.',
		accentColor: 'warning' as const,
	},
	{
		icon: Users,
		...
		description:
			'Боитесь повторить судьбу близких со здоровьем. Хотите делать что‑то заранее и видеть, как именно ваши шаги снижают риск.',
		accentColor: 'warning' as const,
	},
];
				...
				<ScrollReveal>
					<div className='text-center mb-16'>
						...
						<p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
							Pinch для тех, кто хочет понять, что делать для избежания
							заболеваний
						</p>
					</div>
				</ScrollReveal>
